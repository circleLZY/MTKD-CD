...
# Root directories
root_image_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures-KD/TEST/Two-Teachers'
root_checkpoint_dir = '/nas/datasets/lzy/RS-ChangeDetection/Best_ckpt-KD-Ablation'
root_output_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures-KD/TEST/Two-Teachers'
