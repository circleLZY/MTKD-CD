...
# Root directories
root_image_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures-KD/VAL/Three-Teachers'
root_checkpoint_dir = '/nas/datasets/lzy/RS-ChangeDetection/Best_ckpt-KD'
root_output_dir = '/nas/datasets/lzy/RS-ChangeDetection/Figures-KD/VAL/Three-Teachers'
gt_folder = '/nas/datasets/lzy/RS-ChangeDetection/CGWX/val/label'
test_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX/val'
test_s_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX/val_s'
test_m_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX/val_m'
test_l_dir = '/nas/datasets/lzy/RS-ChangeDetection/CGWX/val_l'
