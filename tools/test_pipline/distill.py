...
def process_initial_model(model_name, model_checkpoint_path):
    initial_checkpoint_dir = os.path.join(model_checkpoint_path, 'distill')
    ...
    output_dir = os.path.join(root_output_dir, model_name, 'distill')
...
if __name__ == '__main__':
    # models_to_run = ["BAN-vit-l14-clip-mit-b2", "BIT", "CGNet", "ChangeFormer-mit-b0", "ChangeFormer-mit-b1", 
    #                  "Changer-mit-b0", "Changer-mit-b1", "Changer-r18", "Changer-s50", "ChangeStar-farseg", 
    #                  "ChangeStar-upernet", "HANet", "IFN", "LightCDNet", "SNUNet", "STANet", "TinyCD", "TTP"]  
    models_to_run = [
        # "BAN-vit-l14-clip-mit-b2", 
        # "BIT", 
        "CGNet", 
        "ChangeFormer-mit-b0", 
        # "ChangeFormer-mit-b1", 
