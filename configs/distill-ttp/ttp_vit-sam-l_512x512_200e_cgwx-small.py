...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='train_augment_s_3/label',
            img_path_from='train_augment_s_3/A', 
            img_path_to='train_augment_s_3/B'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='val_s_3/label',
            img_path_from='val_s_3/A',
            img_path_to='val_s_3/B'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            seg_map_path='test_s_3/label',
            img_path_from='test_s_3/A',
            img_path_to='test_s_3/B'),
        pipeline=test_pipeline))
